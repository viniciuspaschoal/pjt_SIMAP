...
function HeroHome({ clickGeral, clickPJ, clickSearch, clickGauge }) {
  return (
    <div className='home'>
      <div className="itens-home" onClick={clickGeral}>
        ...
        <h2 className="title-itens">GERAL</h2>
      </div>
      ...
      <div className="itens-home" onClick={clickPJ}>
        ...
        <h2 className="title-itens">PROJETO DE RECOMPOSIÇÃO</h2>
      </div>
      ...
      <div className="itens-home" onClick={clickSearch}>
        ...
        <h2 className="title-itens">BUSCA DETALHADA</h2>
      </div>
      ...
      <div className="itens-home" onClick={clickGauge}>
        ...
        <h2 className="title-itens">GERAR RELATÓRIO</h2>
      </div>
    </div>
  );
}
